...
class RequestsActions:
    ...
    def verify_new_request(self, request_id, request_type):
        ...
        response = self.request_client.get_request_by_id(request_id, role="admin")
    ...
    def update_conversion_rate(self, source_name, endpoint, request_id):
        ...
        response = self.request_client.update_request_rate_by_id(source_name, endpoint, request_id)
        request_id = response['data']['id']
        return request_id
    ...
    def execute_request(self, request_id):
        ...
        self.request_client.change_request_status_by_id(request_id,
                                                        status="execute")

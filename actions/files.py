...
class FilesActions:
    ...
    def __init__(self, app):
        self.app = app
        self.files_helper = FilesHelper(app)
    ...
    def upload_file(self, filename, content_type, user_id):
        ...
        response = self.files_helper.upload_file_from_user(filename, content_type, user_id)
    ...
    def verify_file_upload(self, user_id, file_id):
        ...
        response = self.files_helper.get_all_files_of_user(user_id)
    ...
    def delete_file(self, file_id):
        ...
        self.files_helper.delete_file_by_id(file_id)
